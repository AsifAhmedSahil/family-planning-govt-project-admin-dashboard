...
const Unit = () => {
  ...
  const fetchUnits = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/api/setup/get-units",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/setup/add-unit", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/api/setup/delete-unit",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/api/setup/update-unit",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
